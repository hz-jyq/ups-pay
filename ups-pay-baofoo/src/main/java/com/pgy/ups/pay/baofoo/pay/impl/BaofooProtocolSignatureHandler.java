...
public class BaofooProtocolSignatureHandler extends SignatureBindBaseCore
		implements BussinessHandler<UpsSignatureParamModel, UpsResultModel> {
	...
	private Logger logger = LoggerFactory.getLogger(BaofooProtocolSignatureHandler.class);
