...
public class BaofooProtocolCollectServiceImpl implements ProtocolCollectService {
	...
	@Override
	public UpsResultModel protocolCollet(UpsOrderEntity orderEntity) throws BussinessException {

		// 查询用户协议信息
		UpsAuthSignEntity uasbe = upsAuthSignBaofooService.queryProtocolSign(orderEntity.getProductId(),
		...
		String version = "4.0.0.0";//MapUtils.getString(baofooConfig, "version", "");
	...
	public void httpRemoteInvoke(String request_url,Map<String, String> postData,String public_key,UpsOrderEntity orderEntity) {
		...
		utl.setProductId(orderEntity.getProductId());
