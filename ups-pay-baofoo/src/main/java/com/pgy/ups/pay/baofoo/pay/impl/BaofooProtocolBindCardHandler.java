...
public class BaofooProtocolBindCardHandler extends SignatureBindBaseCore implements BussinessHandler<UpsBindCardParamModel, UpsResultModel> {

	private Logger logger = LoggerFactory.getLogger(BaofooProtocolBindCardHandler.class);
	...
	@Override
	public UpsResultModel handler(UpsBindCardParamModel upsBindCardParamModel) throws BussinessException {
		...
		String configStr = upsThirdpartyConfigService.queryThirdpartyConfig(upsBindCardParamModel.getPayChannel(),
				upsBindCardParamModel.getOrderType(), upsBindCardParamModel.getFromSystem()).getConfigDate();
