...
public class BaofooBindCardHandler extends SignatureBindBaseCore
		implements BussinessHandler<UpsBindCardParamModel, UpsResultModel> {

	@Value("${ups.runtime.environment.rsa.path}")
	private String RSA_KEY_PATH;

	private Logger logger = LoggerFactory.getLogger(BaofooBindCardHandler.class);
