...
import com.pgy.ups.pay.lakala.utils.LakalaUtils;
...
public class LakalaCollectServiceImpl implements CollectService {
	...
	private Logger logger = LoggerFactory.getLogger(LakalaCollectServiceImpl.class);
	...
	public void httpRemoteInvoke(String requestUrl, YopRequest yoprequest, UpsOrderEntity upsOrderEntity,
		...
		try {
			yopresponse = LakalaUtils.submit(requestUrl, yoprequest);
		} catch (IOException e) {
		...
		utl.setProductId(upsOrderEntity.getProductId());
