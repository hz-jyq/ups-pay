...
public class LakalaPayOrderQueryServiceImpl implements OrderQueryService<String> {

	private Logger logger = LoggerFactory.getLogger(LakalaPayOrderQueryServiceImpl.class);
