package com.pgy.ups.pay.lakala.query.impl;
...
public class LakalaCollectOrderQueryServiceImpl implements OrderQueryService<String> {

	private Logger logger = LoggerFactory.getLogger(LakalaCollectOrderQueryServiceImpl.class);
	...
	public String doSingleQuery(OrderPushEntity ope, boolean queryOnly) throws BussinessException{
		...
		try {
			yopresponse = LakalaUtils.submit(queryUrl, yoprequest);
		} catch (IOException e) {
