...
public class ThreadAsynConfiguration implements AsyncConfigurer {
	...
	public java.util.concurrent.ThreadPoolExecutor threadPoolExcutor(){
		return new java.util.concurrent.ThreadPoolExecutor(8,40,10, TimeUnit.SECONDS,new LinkedBlockingQueue<>(1000),new java.util.concurrent.ThreadPoolExecutor.CallerRunsPolicy() );
	}
}
