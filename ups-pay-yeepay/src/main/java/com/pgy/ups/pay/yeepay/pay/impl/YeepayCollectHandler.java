...
public class YeepayCollectHandler implements BussinessHandler<UpsOrderEntity, UpsResultModel> {

	private Logger logger = LoggerFactory.getLogger(YeepayCollectHandler.class);
	
	@Resource
	private YeepayCollectHttpRemoteInvoke yeepayCollectHttpRemoteInvoke;

	@Override
	public UpsResultModel handler(UpsOrderEntity upsOrderEntity) throws BussinessException{
		...
		// 向YOP发请求
		yeepayCollectHttpRemoteInvoke.httpRemoteInvoke(requestUrl, yoprequest, upsOrderEntity, requestText);
...
@Component
class YeepayCollectHttpRemoteInvoke {

	private Logger logger = LoggerFactory.getLogger(YeepayCollectHttpRemoteInvoke.class);
	...
	public void httpRemoteInvoke(String requestUrl, YopRequest yoprequest, UpsOrderEntity upsOrderEntity,
		...
		utl.setFormSystem(upsOrderEntity.getFromSystem());
