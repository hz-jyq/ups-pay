...
public class YeepayBindCardHandler extends SignatureBindBaseCore implements BussinessHandler<UpsBindCardParamModel, UpsResultModel> {
	...
	private Logger logger = LoggerFactory.getLogger(YeepayBindCardHandler.class);
