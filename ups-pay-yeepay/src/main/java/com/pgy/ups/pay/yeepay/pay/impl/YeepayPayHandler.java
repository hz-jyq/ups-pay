...
public class YeepayPayHandler implements BussinessHandler<UpsOrderEntity, UpsResultModel>{

	private Logger logger = LoggerFactory.getLogger(YeepayPayHandler.class);
	
	@Resource
	private YeepayPayHttpRemoteInvoke yeepayPayHttpRemoteInvoke;
	...
	public UpsResultModel handler(UpsOrderEntity upsOrderEntity) throws BussinessException{
		...
		yeepayPayHttpRemoteInvoke.httpRemoteInvoke(requestUrl, yoprequest, upsOrderEntity, requestText);
...
@Component
class YeepayPayHttpRemoteInvoke{
	
	private Logger logger = LoggerFactory.getLogger(YeepayPayHttpRemoteInvoke.class);
